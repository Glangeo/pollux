...
var CredentialsModel = /** @class */ (function () {
    function CredentialsModel(dao, pbkdf2) {
        this.dao = dao;
        this.pbkdf2 = pbkdf2;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        salt = this.pbkdf2.generateSalt();
                        hashedPassword = this.pbkdf2.getHash(password, salt);
    ...
    CredentialsModel.prototype.authenticate = function (login, password) {
        return __awaiter(this, void 0, void 0, function () {
            var credentials, hashedPassword;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dao.getByLogin(login)];
                    case 1:
                        credentials = _a.sent();
                        hashedPassword = this.pbkdf2.getHash(password, credentials.salt);
