...
export declare function getClientCollection<T extends ClientPartials.Type = string, P extends ClientPartials.Permissions = null, M extends ClientPartials.Meta = null>(db: MongoDB, name?: string, getPermissions?: () => P, getMeta?: () => M): import("../../../../../db/drivers/mongo").Collection<WithId<Client<T, P, M>>, WithId<WithId<Client<T, P, M>>>, {
    id: number;
    isBlocked: boolean;
    refreshedAt: number;
    createdAt: number;
