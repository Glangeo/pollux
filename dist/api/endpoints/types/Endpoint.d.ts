 ...
 */
export declare type Endpoint<M extends EndpointMethod, Q extends ValidationSchema | undefined, P extends ValidationSchema | undefined, B extends ValidationSchema | undefined> = {
    /**
     * Request method
     */
    readonly method: M;
     ...
     */
    readonly action: (data: EndpointPartials.RequestData<Q, P, B>, context: Context, req: express.Request, res: express.Response) => Promise<any>;
    /**
     * Endpoint path
     *
     ...
     */
    readonly onBeforeValidation?: (req: express.Request, res: express.Response) => Promise<void>;
};
/**
