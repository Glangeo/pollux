...
var MongoDB = /** @class */ (function () {
    function MongoDB(connectionUri, primaryDbName) {
        this.connectionUri = connectionUri;
        this.primaryDbName = primaryDbName;
        this.connection = new mongodb_1.MongoClient(this.connectionUri);
    }
    MongoDB.prototype.getDb = function (dbName) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        local_utils_1.DevelopmentLogger.LOG(local_utils_1.DevLogEvent.DbConnected, this.connectionUri);
                        return [2 /*return*/];
                }
            });
        });
