...
export declare class DAO<T extends EntitySchema, R extends RecordSchema<T>, F extends Partial<R>> {
    private readonly db;
    private readonly collection;
    private readonly options;
    constructor(db: Db, collection: PolluxCollection<T, R, F>, options?: DAOOptions<T, R, F>);
